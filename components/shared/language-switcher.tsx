    ...
    <div ref={rootRef} className="relative inline-block text-left">
      ...
      <button
        ...
        className={cn(
          ...
          'hover:border-amber-500/60 hover:shadow-[0_0_16px_rgba(245,208,97,0.2)] active:scale-95'
        )}
      >
        ...
        <ChevronDown
          className={cn('h-3.5 w-3.5 text-amber-300 transition-transform', open && 'rotate-180')}
        />
      </button>
